...
function showUploadDialog(s_Type, s_Link, s_Thumbnail){
	var arr = showModalDialog("../editor/dialog/i_upload.htm?style=forstore&type="+s_Type+"&link="+s_Link+"&thumbnail="+s_Thumbnail, window, "dialogWidth:0px;dialogHeight:0px;help:no;scroll:no;status:no");
...
<h1>商家推荐----添加</h1>
<div id="wrapper">
<form action="store-add-save.asp" method="post" target="_blank" name="myform">

<label for="title">商家名称</label><input name="title" type="text" size="50" maxlength="50"/>
<hr />

<div class="authorInfor">
	<label for="author">商家简介(显示在首页)及图片:</label><textarea name="s_contant" cols="40" rows="10" ></textarea>
	<img src="../image/nopeole.gif" width="250" height="150" id="peoImg" title="显示在首页的图片" />
	<div>
		<input type=text name='imgin' id="imgin" size=50 onchange="showright('peoImg','imgin')"><input type=button id="toUpImg" value="首页图片..." onclick="showUploadDialog('image', 'myform.imgin', '')" />
...
<label for="contant">全文</label>
	...
	<iframe id="eWebEditor1" src="../editor/ewebeditor.htm?id=contant&amp;style=forstore" frameborder="0" scrolling="no" width="600" height="350"></iframe>
<br />

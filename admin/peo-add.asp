...
<%
	sql="select top 1 week,name from people order by week desc"
...
<body>
<h1>本周人物添加</h1>
   <form name="peoadd" action="peo-add-save.asp" method="post" target="_blank">
<table width="800" border="1">
  <tr bgcolor="#CCCCCC">
    <td width="150"><div align="right"><span>*</span>第:</div></td>
    <td><label>
      <div align="left">
        <input name="week" type="text" id="week" size="3" maxlength="2" value="<%=week+1%>" />
        周人物&nbsp;&nbsp; <span>#上一周是第&nbsp;<a href="../people.asp?week=<%=week%>" target="_blank"><%=week%></a>&nbsp;周,人物： <a href="../people.asp?week=<%=week%>" target="_blank"><%=peoplename%></a></span>
      </div>
    </label></td>
  </tr>
  <tr bgcolor="#D5D8B4">
  ...
  <tr bgcolor="#D5D8B4">
    ...
    <!--------------------------------首页人物图片---------------------------------->
      <div align="left">
        <input name="indeximg" type="text" id="indeximg" size="40" onblur="showright('showimg', 'indeximg');" />
    ...
    <!--------------------------------第一张人物小图片---------------------------------->
     <div align="left">
      	第一张小图片：
        <input name="sinput01" type="text" id="sinput01" size="40" onblur="showright('simg01', 'sinput01');" />
    ...
    <!--------------------------------第二张人物小图片---------------------------------->
     <div align="left">
      	第二张小图片：
        <input name="sinput02" type="text" id="sinput02" size="40" onblur="showright('simg02', 'sinput02');" />
    ...
    <!--------------------------------第三张人物小图片---------------------------------->
     <div align="left">
      	第三张小图片：
        <input name="sinput03" type="text" id="sinput03" size="40" onblur="showright('simg03', 'sinput03');" />
    ...
    <!--------------------------------第四张人物小图片---------------------------------->
     <div align="left">
      	第四张小图片：
        <input name="sinput04" type="text" id="sinput04" size="40" onblur="showright('simg04', 'sinput04');" />
    ...
    <!--------------------------------第一张人物大图片---------------------------------->
     <div align="left">
      	第一张大图片：
        <input name="input01" type="text" id="input01" size="40" onblur="showright('img01', 'input01');" />
    ...
    <!--------------------------------第二张人物大图片---------------------------------->
     <div align="left">
      	第二张大图片：
        <input name="input02" type="text" id="input02" size="40" onblur="showright('img02', 'input02');" />
    ...
    <!--------------------------------第三张人物大图片---------------------------------->
     <div align="left">
      	第三张大图片：
        <input name="input03" type="text" id="input03" size="40" onblur="showright('img03', 'input03');" />
    ...
    <!--------------------------------第四张人物大图片---------------------------------->
     <div align="left">
      	第四张大图片：
        <input name="input04" type="text" id="input04" size="40" onblur="showright('img04', 'input04');" />
...
function comeback(tebox, textimg, upbotton, deleteimg) //函数的作用是删除本地图片以后，重新隐藏图片，“删除图片”文字隐藏，文本框和按钮重新可用
  ...
  <tr bgcolor="#D5D8B4">
    ...
    <td><label>
      <div align="left">
        <input name="hometown" type="text" id="hometown" size="50" maxlength="50" />
  ...
  <tr bgcolor="#C6E6DB">
    ...
    <td><label>
      <div align="left">
        <input name="expertise" type="text" id="expertise" maxlength="255" />
  ...
  <tr bgcolor="#C6E6DB">
    ...
    <td><label>
      <div align="left">
        <input name="interest" type="text" id="interest" maxlength="255" />
      	<span>#必须在255个字内</span>      </div>
    </label></td>
  </tr>
  <tr bgcolor="#C6E6DB">
    ...
    <td><label>
      <div align="left"><textarea name="motto" cols="50" rows="5"></textarea><span>#必须在255个字内</span>      </div>
    </label></td>
  </tr>
  <tr bgcolor="#C6E6DB">
    ...
    <td><label>
      <div align="left">
        <textarea name="experience" id="experience" cols="70" rows="5" onfocus="todosth(this);"></textarea>
  ...
  <tr bgcolor="#E7F5AD">
    ...
    <td><label>
      <div align="left">
        <textarea name="s_contant" id="s_contant" cols="70" rows="5" onfocus="todosth(this);" ></textarea>
  ...
  <tr bgcolor="#E7F5AD">
    ...
    <td><label>
      <div align="left">
        <textarea name="contant" id="contant" cols="70" rows="5" onfocus="todosth(this);"></textarea>

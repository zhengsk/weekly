...
<%
	...
	sql="select * from store_remark where ord="&ord
	set rs=conn.execute(sql)
%>
<form action="store-remark-modify.asp?ord=<%=ord%>&action=save" method="post">
...
set rs=nothing
	...
	sql="update store_remark set remark_name='"&remarkname&"',remark='"&remark&"',face='"&face&"' where ord="&ord
	conn.execute(sql)
	conn.close
	set conn=nothing
%>

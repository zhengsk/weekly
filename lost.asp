...
<div class="footer">
    	<% '---------------------------------------------这个是为了得到显示导航
			if page=1 then 
				...
				a="<a href=""lost.asp?page="& page-1&""">上一页</a>"
				aa="<a href=""lost.asp?page=1"">&nbsp;&nbsp;首页&nbsp;&nbsp;</a>"
			end if 
			...
			if page=allpage then 
				...
				b="<a href=""lost.asp?page="& page+1&""">下一页</a>"
				bb="<a href=""lost.asp?page="&allpage&""">&nbsp;&nbsp;尾页&nbsp;&nbsp;</a>"
			end if 
		%>

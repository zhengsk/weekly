...
.showall_ul li span.s_contant{display:none;}
.showall_ul li .show_contant{display:block;background-color:#ecf5d3; margin:15px 5px 0 5px; padding:10px 20px; height:50px; overflow:hide;cursor:pointer;font-size:12px; color:#182937; }
...
<div class="main">
 ...
 <!------------------------------------------------------------文章标题--------->
	 ...
	 sql="select ID,title,author,tim,contant from news"
	...
	response.Write(" <ul class=""showall_ul"">")
	 ...
	 for i=1 to rs.pagesize
	 	if i mod 2<>0 then
	 		response.Write("<li><a href=""news.asp?ID="&rs("ID")&""" name=""list"" ><span class=""title"">"&rs("title")&"</span><span class=""time"">"&left(rs("tim"),10)&"</span><span class=""author"">"&rs("author")&"</span><span class=""s_contant"">"&left(rs("contant"),50)&"……</span></a></li>")
	 		rs.movenext
		else 
	 		response.Write("<li class=""libgcolor""><a href=""news.asp?ID="&rs("ID")&""" name=""list"" ><span class=""title"">"&rs("title")&"</span><span class=""time"">"&left(rs("tim"),10)&"</span><span class=""author"">"&rs("author")&"</span><span class=""s_contant"">"&left(rs("contant"),50)&"……</span></a></li>")
	 		rs.movenext
		end if 
	 	if rs.eof=true then 
			exit for

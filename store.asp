...
// JavaScript Document
  ...
  function mainAjax()		//对象上的函数 , 为主要的Ajax方法.
  {
	 if(showall=="false")
	  ...
	  var url="store-remark-for-ajax.asp?id="+ theID +"&showall="+ showall
...
<div class="main">
  <div class="left">
        ...
        <div class="pre-nex"> <!--#include file="store-pre-next.asp"--> </div><!--------------------------------------------上下导航--------->
   	<div class="remark" id="remark">
   		<!--#include file="store-remark.asp"--> <!--------------------------------------------留言内容------------------------>	
   	</div>

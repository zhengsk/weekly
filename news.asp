...
<script type="text/javascript" language="javascript" defer="defer">
  ...
  function mainAjax()		//对象上的函数 , 为主要的Ajax方法.
  {
	 if(showall=="false")
	  ...
	  var url="news-remark-for-ajax.asp?id="+ theID +"&showall="+ showall;
...
<div class="main">
  <div class="left">
		<h5><%=newstitle%></h5><!------------------------------------------------------------文章标题--------->
		<div class="article"><%=newscontant%></div><!--------------------------------------------文章内容--------->
        <div class="pre-nex"> <!--#include file="news-pre-next.asp"--> </div><!--------------------------------------------上下篇文章导航--------->
   	<div class="remark" id="remark">
   		<!--#include file="news-remark.asp"--> 									
   	</div>
    ...
    <a class="toallimg" href="news-showall.asp" title="查看更多新闻" id="toall" onfocus="this.blur()"><div></div></a>
	<div class="newestarticle"><!------------------------------------------------------------------------热门文章--------->
        <p class="newest">最新新闻</p>
